...
class ShirtRender<T: PlayerEntity, M: PlayerEntityModel<T>>(context: FeatureRendererContext<T, M>?) : FeatureRenderer<T, M>(
    context
) {
    override fun render(
        ...
        if (stack.item is GardenerShirt) {
            ...
            val model = ModelIdentifier("sc", "gardener_shirt", "inventory")
